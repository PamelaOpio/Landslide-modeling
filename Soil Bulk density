...
//Determine mean for soil depth 0-20cm//
var mean_0_20 =
'<RasterSymbolizer>' +
 '<ColorMap type="ramp">' +
...
//Determine mean for soil depth 20-50cm//
var mean_20_50 =
'<RasterSymbolizer>' +
 '<ColorMap type="ramp">' +
  '<ColorMapEntry color="#00204D" label="0.8-1.05" opacity="1" quantity="105"/>' +
...
//Determine standard deviation for soil depth 0-20cm//
var stdev_0_20 =
'<RasterSymbolizer>' +
 '<ColorMap type="ramp">' +
...
//Determine standard deviation for soil depth 20-50cm//
var stdev_20_50 =
'<RasterSymbolizer>' +
 '<ColorMap type="ramp">' +
  '<ColorMapEntry color="#fde725" label="low" opacity="1" quantity="2"/>' +
...
//Retrieve the Soil Bulk density data from ISDASOIL//
...
var Uganda_soil = raw.clip(Uganda)
Map.addLayer(Uganda_soil, style, 'Soil Bulk density (Uganda)')

//Export the soil map to Google Drive
Export.image.toDrive({
 image: Uganda_soil,
 description: 'Uganda_Soil_Bulk_density',
 folder: 'Google_Earth_Engine',
 fileNamePrefix: 'uganda_soil_bulk_density_2022',
 scale: 1000,
 maxPixels: 1E10
})
